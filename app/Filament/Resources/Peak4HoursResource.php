...
use App\Filament\Resources\Peak4HoursResource\Pages;
use App\Filament\Resources\Peak4HoursResource\RelationManagers;
...
class Peak4HoursResource extends Resource
{
    protected static ?string $model = Peak4Hours::class;
    ...
    {
        return [
            'index' => Pages\ListPeak4Hours::route('/'),
            'create' => Pages\CreatePeak4Hours::route('/create'),
            'edit' => Pages\EditPeak4Hours::route('/{record}/edit'),
        ];
    }
}
